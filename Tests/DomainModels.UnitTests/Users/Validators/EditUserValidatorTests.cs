...
namespace Helpdesk.DomainModels.UnitTests.Users.Validators
{
    ...
    public class EditUserValidatorTests
    {
        ...
        public void Setup()
        {
            _validator = new EditUserValidator();
        }

        [TestCase(null)]
        [TestCase("")]
        [TestCase(" ")]
        public void ShouldNotHaveError_WhenNameIsNullOrWhitespace(string name)
        {
        ...
        [TestCase("")]
        [TestCase(" ")]
        public void ShouldNotHaveError_WhenSurnameIsNullOrWhitespace(string surname)
        {
        ...
        [TestCase("")]
        [TestCase(" ")]
        public void ShouldNotHaveError_WhenUsernameIsNullOrWhitespace(string username)
        {
        ...
        [TestCase(null)]
        [TestCase("")]
        public void ShouldNotHaveError_WhenEmailIsNullOrWhitespace(string email)
        {
