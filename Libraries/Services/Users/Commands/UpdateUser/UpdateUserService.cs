...
namespace Helpdesk.Services.Users.Commands.UpdateUser
{
    public class UpdateUserService
    {
        ...
        public virtual async Task<UpdateUserResult> Update(int userId, EditUser userUpdates)
        {
        ...
        public virtual async Task<UpdateUserResult> Update(string username, EditUser userUpdates)
        {
            if (userUpdates == null) throw new ArgumentNullException(nameof(userUpdates));
